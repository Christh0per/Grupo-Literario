<template>
  <v-app>
    <!-- About -->
    <b-section class="page-section" id="about">
      <b-container>
        <b-row>
            ...
            <ul class="timeline">
              <li>
                <div class="timeline-image">
                  <b-img class="rounded-circle img-fluid" src="https://lacovacha.mx/wp-content/uploads/2018/09/descarga-400x300.jpg" alt></b-img>
                </div>
              ...
              <li class="timeline-inverted">
                <div class="timeline-image">
                  <img class="rounded-circle img-fluid" src="https://bimber.bringthepixel.com/main/wp-content/uploads/sites/17/2019/01/2.png" alt>
                </div>
                <div class="timeline-panel">
                  <div class="timeline-heading">
                    <h4>March 2011</h4>
              ...
              <li>
                <div class="timeline-image">
                  <b-img class="rounded-circle img-fluid" src="img/about/3.jpg" alt></b-img>
                </div>
                <div class="timeline-panel">
                  <div class="timeline-heading">
                    <h4>December 2012</h4>
              ...
              <li class="timeline-inverted">
                <div class="timeline-image">
                  <b-img class="rounded-circle img-fluid" src="img/about/4.jpg" alt></b-img>
                </div>
                <div class="timeline-panel">
                  <div class="timeline-heading">
                    <h4>July 2014</h4>
